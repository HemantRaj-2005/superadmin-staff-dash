...
export const statesAndDistricts = {
  ...
  "Nagaland": [
    "Chumukedima", // Newly added (2021)
    "Dimapur", "Kiphire", "Kohima", "Longleng", "Mokokchung", "Mon",
    "Niuland", // Newly added (2021)
    "Noklak",  // Newly added (2021)
    "Peren", "Phek", "Tseminyü", // Newly added (2021)
  ...
  "Sikkim": [
    ...
    "Pakyong", "Soreng" // Newly added (2021)
  ].sort(),
...
// Helper Functions
export const getAllStates = () => Object.keys(statesAndDistricts).sort();
