...
const InstituteCard = ({
  ...
  return (
    <Card
      className="group cursor-pointer hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-blue-300 dark:hover:border-blue-700 bg-linear-to-br from-white to-blue-50 dark:from-gray-800 dark:to-blue-900/20 shadow-md"
      onClick={() => onInstituteClick(institute)}
    >
      <CardHeader className="pb-3 relative">
        <div className="flex items-start justify-between">
          <div className="flex items-center space-x-3">
            <div className="shrink-0 p-2 bg-linear-to-br from-blue-500 to-green-600 rounded-lg shadow-lg">
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      {institute.name || "this institute"}? This action cannot
                      be undone and will permanently remove the institute from
                      the database.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
