              ...
              <p className="text-gray-600 dark:text-gray-400 flex items-center space-x-2 mt-1">
                ...
                <span>
                  {isEditing ? (
                    ...
                    <>
                      {organisation.location.country} {getCountryFlag(organisation.location.country)}
                    </>
                  )}
                </span>
              </p>
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="p-6 space-y-6">
            ...
            <Card className="border-2 shadow-sm">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <Badge variant="outline" className="mt-1 bg-green-50 text-green-700 border-green-200 dark:bg-green-900/20 dark:text-green-300 text-base">
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <p className="text-lg font-medium dark:text-white mt-1">{organisation.type}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Establishment Year</label>
                      {isEditing ? (
                        <Input
                        ...
                        <div className="flex items-center space-x-2 mt-1">
                          ...
                          <span className="text-lg font-medium dark:text-white">
                            {formatEstablishmentYear(organisation.establishmentYear)}
                          </span>
                        </div>
                      )}
                    </div>
                    ...
                    <div>
                      <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Organisation ID</label>
            ...
            <Card className="border-2 shadow-sm">
              ...
              <CardContent>
                <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-lg">
                  <span className="text-4xl">{getCountryFlag(organisation.location.country)}</span>
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">Country</h3>
                    <p className="text-gray-600 dark:text-gray-400 text-lg">{organisation.location.country}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm dark:text-white">{formatDate(organisation.createdAt)}</p>
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Last Updated</label>
                    <p className="text-sm dark:text-white">{formatDate(organisation.updatedAt)}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-950/20 border-2">
              <CardHeader>
                ...
                <CardDescription className="text-red-700 dark:text-red-400">
                  Once you delete this organisation, there is no going back. Please be certain.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <AlertDialog>
                  ...
                  <AlertDialogContent className="dark:bg-gray-900 dark:border-gray-700">
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription className="dark:text-gray-400">
                        ...
                        "{organisation.name}" and remove all associated data from the database.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
