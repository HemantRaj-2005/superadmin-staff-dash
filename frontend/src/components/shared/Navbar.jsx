...
const Navbar = ({ admin, logout }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-linear-to-r from-[#1D2B53] via-[#1D2B53] to-[#1a2547] text-white shadow-lg border-b border-white/10 backdrop-blur-sm h-16">
        ...
        <div className="flex items-center gap-3 group cursor-pointer">
          <div className="relative">
            <img
              src="logo.png"
              alt="Nucleus Logo"
              className="h-[2.6rem] w-[3.1rem] object-contain rounded-full transition-transform group-hover:scale-110 shadow-lg"
            />
          ...
          <div className="flex flex-col">
            <span className="text-xl font-bold tracking-wider bg-linear-to-r from-white to-gray-200 bg-clip-text text-transparent">
              Nucleus
            </span>
